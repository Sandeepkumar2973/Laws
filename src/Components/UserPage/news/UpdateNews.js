...
const UpdateNews = () => {
  ...
  useEffect(() => {
    const fetchArticleBySlug = async () => {
      try {
        ...
        setTitle(data.title);
        setSortDes(data.shortDescription);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(
        `${mod.api_url}/api/v1/blogs/update_article/${slug}`,
        {
          title,
          description: content,
          subTitle,
      ...
      <Box mt="100px" ml={{ base: 0, md: SIDEBAR_WIDTH }} p={4}>
        <Container maxW="" bg="white" p={6} borderRadius="md" boxShadow="md">
          ...
          <VStack spacing={5} align="stretch">
            ...
            <FormControl>
              <FormLabel>Short News Description</FormLabel>
              <Textarea
            ...
            <FormControl>
              <FormLabel>Upload News Image</FormLabel>
              <Input
                type="file"
                accept="image/*"
